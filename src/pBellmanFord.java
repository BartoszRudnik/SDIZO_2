...
public class pBellmanFord {
    ...
    public void pomiary(){
        ...
        while(spr){
            ...
            System.out.println("1. Algorytm Bellmana-Forda - wersja listowa");
            System.out.println("2. Algorytm Bellmana-Forda - wersja macierzowa");
            ...
            switch(nrOperacji){
                ...
                case 1:
                    ...
                    zapisz("BellmanFordLista.txt",tab);
                    break;
                ...
                case 2:
                    ...
                    for(int i = 0; i < iloscTestow; i++) {
                        ...
                        long sTime = System.nanoTime();
                        //bf.AlgorytmBFMacierz(poczatek,koniec);
                        long fTime = System.nanoTime();
                        fTime -= sTime;
                        tab2[i] = fTime;
                    ...
                    zapisz("BellmanFordMacierz.txt",tab2);
                    break;
